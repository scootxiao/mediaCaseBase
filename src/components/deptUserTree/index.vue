<template>
  <div>
    <div class="dialog-box">
      ...
      <div class="list-warper" style="margin-left:2%;width:49%;height:305px;overflow:auto;">
        <div v-for="(item,index) in selectedData" :key="'id'+index" class="list-item">
          <span class="name">{{ item[props.label] + ' (' + item.parentNode[props.label] + ')' }}</span>
    ...
    props: {
      ...
      default() {
        return {
          ...
          children: 'userList',
          disabled: (data, node) => {
            return data.userList && this.filterText
          }
        }
      }
    },
